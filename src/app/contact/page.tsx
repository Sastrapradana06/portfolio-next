...
export default function ContactPage() {
  ...
  return (
    <AppShell>
      ...
      <div className="w-[90%] h-[90vh] mt-16 flex flex-col items-center justify-center">
        <div className="" id="title">
          <h1 className="text-[1.2rem] lg:text-[1.4rem]" id="font1">Contact Me</h1>
        </div>
        <div className=" w-full h-max p-2 flex flex-col items-center justify-center gap-4">
          <div className="w-full h-[300px] border backdrop-blur-[5px] bg-[#fffdfd11] rounded-lg flex flex-col p-2 lg:w-[50%]">
            <div className=" h-full flex items-center gap-2 pl-4">
              <FaSearchLocation size='30' fill='black'/>
              <p className="" id="color-gray">Medan, Indonesia</p>
            </div>
            <div className=" h-full flex items-center gap-2 pl-4">
              <FaPhoneAlt size='30' fill='black'/>
              <p className="" id="color-gray">+6283870915417</p>
            </div>
            <div className=" h-full flex items-center gap-2 pl-4">
              <MdEmail size='30' fill='black'/>
              <p className="" id="color-gray">sastrapradana535@gmail.com</p>
            </div>
